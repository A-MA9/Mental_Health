...
# --- Configuration ---
model_path = "speech_emotion_recognition_model_lstm.h5"
test_audio_folder = "random_audio_samples_by_emotion"
scaler_path = "scalerLSTM.pkl"  # You need to save your scaler
encoder_path = "encoderLSTM.pkl"  # You need to save your encoder
...
results_df.to_csv('TestResultLSTM2.csv', index=False)
print("\nTest Result has been saved to 'TestResultLSTM.csv'")
